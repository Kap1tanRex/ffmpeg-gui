...
90 проверок, меньше секунды, без FFmpeg и без графической подсистемы: сборка
команды, шкала качества, шаблоны имён, разбор ошибок FFmpeg и откат задания на
процессор, определение видеокарты и драйвера. Проверки интерфейса — прокрутка, подсказки, масштаб — гоняются
