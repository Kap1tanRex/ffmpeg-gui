...
живой драйвер. Если видеокарта всё же отказала посреди работы, задание не
падает с сообщением про NVENC, а само повторяется на процессоре.
...
71 проверка, меньше секунды, без FFmpeg и без графической подсистемы: сборка
команды, шкала качества, шаблоны имён, разбор ошибок FFmpeg и откат задания на
процессор. Проверки интерфейса — прокрутка, подсказки, масштаб — гоняются
